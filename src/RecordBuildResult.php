...
/**
 * Outcome of building one record (instance, holdings, or item) from one
 * input row: either a usable record array, a list of validation errors,
 * or both (a partially-built array is still returned alongside errors,
 * but callers should check {@see hasErrors()} before treating it as valid).
 */
