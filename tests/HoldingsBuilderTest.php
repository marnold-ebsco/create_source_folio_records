...
final class HoldingsBuilderTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        $locations = new LocationResolver([self::MIGRATION_LOCATION_ID => 'Migration']);
    ...
    public function testPermanentLocationIdIsHardcodedToMigrationRegardlessOfRowData(): void {
